    ...
    <section className="relative pt-24 pb-20 px-10 overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="text-left">
          ...
          >
            <div className="w-full flex p-1 bg-[#0A101A] border border-[#1A2333] rounded-lg focus-within:border-[#F0B429] focus-within:shadow-[0_0_15px_rgba(240,180,41,0.2)] transition-all duration-300">
              <input 
                type="email" 
              ...
              <button 
                ...
                className="bg-[#F0B429] text-black px-6 py-3 rounded-md font-bold text-sm hover:opacity-90 transition-opacity"
              >
                Get Early Access →
              </button>
            </div>
            <p className="text-[11px] text-[#4A5568] font-['JetBrains_Mono'] uppercase tracking-widest">
