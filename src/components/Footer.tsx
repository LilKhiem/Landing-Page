...
export const Footer = () => (
  <footer className="border-t border-[#1A2333] p-10 flex flex-wrap items-center justify-between gap-5">
    <div className="font-['Syne'] text-base font-extrabold">NEXUS<span className="text-[#F0B429]">IDE</span> <span className="text-[#3A4A5C] font-normal text-[13px]">by AlgoXpert</span></div>
