...
const plans = [
  {
    ...
    desc: "For lone wolves testing ideas.",
    features: ["5 strategy verifications / mo", "Basic slippage modeling", "Community access", "Standard compute"],
    cta: "Start for Free",
    popular: false
  },
  {
    ...
    desc: "For serious prop traders.",
    features: ["Unlimited verifications", "Full 24-gate gauntlet", "Evidence Ledger access", "Priority GPU compute", "Verified Audit Badges"],
    cta: "Get Started",
    popular: true
  },
  {
    ...
    features: ["Unlimited verifications", "Private Ledger Instance", "White-label Audit Reports", "Custom Risk Gates", "Dedicated Quant Support"],
    cta: "Enquire for Fund-Grade Audit",
    popular: false
  }
];
